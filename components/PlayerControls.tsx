...
export default function PlayerControls({
  ...
  return (
    <aside 
      ...
      className={`fixed bottom-4 xs:bottom-5 sm:bottom-6 left-1/2 -translate-x-1/2 z-[140] flex items-center gap-2 sm:gap-3 bg-black/85 hover:bg-black/95 backdrop-blur-2xl border border-emerald-500/40 px-3 py-1.5 sm:px-5 sm:py-2.5 rounded-2xl sm:rounded-3xl shadow-[0_10px_35px_rgba(0,0,0,0.8),0_0_20px_rgba(16,185,129,0.25)] transition-all duration-300 pointer-events-auto select-none ${className}`}
    >
      {/* 1. Undo 5s Button */}
      <button 
        type="button"
